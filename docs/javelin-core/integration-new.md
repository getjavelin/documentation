...
Javelin supports all the [latest models and providers](supported-llms.md), so you don't have to make any changes to your application or how requests to models are sent.

See the [Javelin Configuration](administration/createroute.md) section for details on how to set up routes on the gateway to different models and providers.

For programmatic integration, see the [Python SDK](../javelin-python/quickstart.md) documentation for details on how you can easily embed Javelin within your AI applications.
